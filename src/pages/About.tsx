        ...
        <div className='text-center mb-6'>
          ...
          <div className="flex">
            ...
            <CardAbout
              ...
              img={paris2024}
              text1='Com os jogos de 2024, Paris terá sido sede das olímpiadas por três vezes (1900, 1994 e 2024), a única com o feito ao lado de Londres (1908, 1948, 2012). Tornando a França o segundo país que mais sediou os jogos olimpicos, ficando atrás somento dos EUA.'
